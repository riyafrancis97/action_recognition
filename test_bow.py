# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 06:10:13 2019
...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 04:36:21 2019
...
if __name__ == "__main__":
    ...
    parser.add_argument("--codebook", type=str, default="data/cb_200clusters.p",
        help="path to codebook file")
    parser.add_argument("--tfidf", type=int, default=1,
        help="whether to use tfidf weighting")
    parser.add_argument("--dataset", type=str, default="data/test.p",
        help="path to dataset file")
    parser.add_argument("--output", type=str, default="data/test_bow_c200.p",
